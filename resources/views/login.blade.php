        ...
        <div class="w-1/2 flex justify-center items-center p-8">
            <div class="bg-violet-200 p-16 rounded-lg w-full">
                <form action="#" method="POST">
                    ...
                    <br>
                    <div class="mb-4">
                        <input type="username" id="username" name="username" placeholder="Username" class="w-full bg-violet-400 border-violet-700 hover:bg-violet-500 rounded-md p-2 focus:outline-none focus:border-violet-700 text-white" required>
                    </div>
                    <div class="mb-4">
