...
<body>
  ...
  <div class="flex text-center align-center justify-center items-center p-5 p-32">
    ...
    <div class="flex-1 w-14 ...">
      <h1 class="font-bold underline">Detail Buku: </h1> <br>
      <div class="text-center">
        <h2 class="font-bold">Judul: </h2> {{$DetailBuku->nama_buku}} <br>
        <h2 class="font-bold">Pengarang:</h2> {{$DetailBuku->pengarang}} <br>
        <h2 class="font-bold">Penerbit:</h2> {{$DetailBuku->penerbit}} <br>
        <h2 class="font-bold">ISBN:</h2>{{$DetailBuku->ISBN}} <br>
