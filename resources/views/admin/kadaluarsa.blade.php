    ...
    <div class="grid grid-cols-4">
        ...
        <div class="flex flex-col w-5/10 w-8/10 mx-auto col-span-3">
            <div class="p-5 m-5">
                ...
                <div class="relative overflow-x-auto">
                    <table
                        class="w-full text-sm text-center rtl:text-right text-gray-500 dark:text-gray-400 border border-grey-500">
                        <thead class="text-xs text-gray-700 uppercase bg-blue-50 dark:bg-blue-700 dark:text-gray-400">
                            <tr>
                        ...
                        <tbody>
                            @foreach ($kadaluarsa as $datas)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                                    ...
                                    <td class="px-6 py-4 border border-grey-500">
                                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold rounded flex">
                                            Perpanjang Manual</button>
                                        <button class="bg-red-500 hover:bg-red-700 text-white font-bold rounded flex">
                                            Hubungi Penyewa</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
