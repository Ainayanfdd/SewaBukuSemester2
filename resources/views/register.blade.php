        ...
        <div class="w-1/2 flex justify-center items-center p-8">
            <div class="bg-violet-200 p-16 rounded-lg w-full">
                <form action="#" method="POST">
                    ...
                    <br>
                    <div class="mb-4">
                        <input type="text" id="first_name" name="first_name" placeholder="Nama Depan" class="w-full bg-violet-400 border-violet-700 hover:bg-violet-500 rounded-md p-2 focus:outline-none focus:border-violet-700 text-white" required>
                    </div>
                    <div class="mb-4">
                        <input type="text" id="last_name" name="last_name" placeholder="Nama Belakang" class="w-full bg-violet-400 border-violet-700 hover:bg-violet-500 rounded-md p-2 focus:outline-none focus:border-violet-700 text-white" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <input type="text" id="username" name="username" placeholder="Username" class="w-full bg-violet-400 border-violet-700 hover:bg-violet-500 rounded-md p-2 focus:outline-none focus:border-violet-700 text-white" required>
                    </div>
                    <div class="mb-4">
